...
def solve_problem_with_agents(question: str, max_iterations: int = 22, 
    ...
    for iteration in range(max_iterations):
        ...
        try:
            ...
            if "<answer>" in response:
                ...
                return final_answer, total_usage, total_latency, total_cost, flops
            else:
    ...
    # 如果达到最大迭代次数仍未找到答案
    return None, total_usage, total_latency, total_cost, flops
...
def process_difficulty_level(difficulty):
    ...
    with open(filename, "r", encoding="utf-8") as file:
        ...
        # problems = problems[20:30]  # 只处理第21到第30个问题
    ...
    for i, problem in enumerate(problems, 1):
        ...
        try:
            # 使用多智能体方法解决问题
            final_answer, usage, latency, cost, flop = solve_problem_with_agents(user_prompt)
            ...
            problem_detail = {
                ...
                "prompt_tokens": usage["prompt_tokens"],   # 新增：记录prompt tokens
                "completion_tokens": usage["completion_tokens"],   # 新增：记录completion tokens
                "latency": latency,
                "cost": cost,
                "flops": usage["total_tokens"]**2 # 新增：记录FLOPs
            }
            ...
            print(f"(Prompt: {usage['prompt_tokens']}, Completion: {usage['completion_tokens']}) | ", end="")  # 新增：显示prompt和completion tokens
            print(f"FLOPs: {flop} | ", end="")
